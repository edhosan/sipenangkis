	  ...
	  <div class="col-md-12" v-if="isAction == 'list'">
	    <div class="box box-warning">
	      <div class="box-header with-border">
	        <h3 class="box-title">Daftar Penerima Manfaat Kelompok</h3>
	      </div>
	      <!-- /.box-header -->
	      <div class="box-body">
	        <div class="row">
...
export default{
	data(){
		return{
		  isAction: 'list',
		  per_page: 10,
	      url: this.$root.$config.API + '/api/program_intervensi/index_kelompok',
	      fields:[
	...
	events:{
    	'vuetable:action': function(action, data) {
        	this.$Progress.start()
         	if (action == 'edit-item') {
           		this.$router.go({path:'/pengajuan/detail_kelompok/'+data.id})
         	}
    	}
    }
}
